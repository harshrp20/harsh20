...
<p style="width: 350px;">
<b>Email</b>  <input type="text" class="form-control" placeholder="Email id" name="email" id="email" onBlur="return checkmail();" required><span id="eid"></span>

	</p> 

	<p style="width: 350px;">
<b>Mobile No</b>  <input type="text"  class="form-control" placeholder="Mobile number" maxlength="10" name="mobilenumber" id="mob" onblur="return checkmob();" required><span id="mobile"></span>
	</p> 
